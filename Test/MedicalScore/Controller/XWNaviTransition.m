...
{
    MedicalContentController *fromVC = (MedicalContentController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    ...
    MedicalImageCell *cell = (MedicalImageCell *)[fromVC.chooseImageView cellForItemAtIndexPath:fromVC.currentIndexPath];
...
- (void)doPopAnimation:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    MedicalContentController *toVC = (MedicalContentController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    MedicalImageCell *cell = (MedicalImageCell *)[toVC.chooseImageView cellForItemAtIndexPath:toVC.currentIndexPath];
    UIView *containerView = [transitionContext containerView];
